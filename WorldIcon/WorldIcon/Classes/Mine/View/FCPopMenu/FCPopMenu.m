...
-(instancetype)initWithFrame:(CGRect)frame trangleHeight:(CGFloat)trangleHeight tranglePosition:(CGPoint)tranglePosition items:(NSArray<FCPopMenuItem *> *)items{
    ...
    if(self=[super initWithFrame:frame]){
        ...
        _sperateColor= KBackgroundColor;
...
-(void)createUI{
    ...
    if(direction==FCPopMenuArrwoDirectionUp){
        ...
        rect=CGRectMake(0, _trangleHeight, self.frame.size.width, 140-_trangleHeight);
    ...
    _tbView.layer.cornerRadius= [UIView countBeforeWithIphone5Length:30]/2.0f;
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.textLabel.textColor=[UIColor gc_colorWithHexString:@"#666666"];

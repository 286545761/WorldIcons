...
- (instancetype)initWithMessage:(NSString *)message sureBtn:(NSString *)sureTitle cancleBtn:(NSString *)cancleTitle
{
    if (self == [super init]) {
        ...
        self.backgroundColor = [UIColor gc_colorWithHexString:@"#000000" alpha:0.6];
        ...
        if (message) {
            ...
            self.msgLbl = [UILabel gc_labelWithTitle:@"" withTextColor:[UIColor gc_colorWithHexString:@"#333333"] withTextFont:18 withTextAlignment:(NSTextAlignmentCenter)];
            self.msgLbl.frame = CGRectMake(XLSpace, CGRectGetMaxY(self.titleLbl.frame)+XLSpace, AlertW-2*XLSpace, 20);
        ...
        self.lineView.backgroundColor = [UIColor gc_colorWithHexString:@"#dbdbdb"];
...
//            [self.cancleBtn setBackgroundImage:[self imageWithColor:[UIColor gc_colorWithHexString:@"#666666"]] forState:UIControlStateNormal];
//            [self.cancleBtn setBackgroundImage:[self imageWithColor:[UIColor colorWithRed:255/255.0 green:255/255.0 blue:255/255.0 alpha:0.2]] forState:UIControlStateSelected];
            ...
            [self.cancleBtn setTitleColor:[UIColor gc_colorWithHexString:@"#666666"] forState:UIControlStateNormal];
...
//            [self.sureBtn setBackgroundImage:[self imageWithColor:[UIColor gc_colorWithHexString:@"#ef3b3c"]] forState:UIControlStateNormal];
//            [self.sureBtn setBackgroundImage:[self imageWithColor:[UIColor colorWithRed:255/255.0 green:255/255.0 blue:255/255.0 alpha:0.2]] forState:UIControlStateSelected];
            ...
            [self.sureBtn setTitleColor:[UIColor gc_colorWithHexString:@"#ef3b3c"] forState:UIControlStateNormal];
            self.sureBtn.tag = 2;

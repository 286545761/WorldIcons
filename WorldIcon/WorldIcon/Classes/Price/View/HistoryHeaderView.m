...
-(void)setUpView{
    ...
    //总金额
    UILabel *allMoneyLabel = [UILabel gc_labelWithTitle:@"总金额" withTextColor:[UIColor gc_colorWithHexString:@"#666666"] withTextFont:(14) withTextAlignment:(NSTextAlignmentCenter)];
...
-(void)updateConstraints{
    ...
    [self.timeLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.size.mas_equalTo(CGSizeMake(kScreenWidth/5, kRatioY6(35)));
    }];

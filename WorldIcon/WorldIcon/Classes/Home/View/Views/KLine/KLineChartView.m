...
- (UIButton *)realDataTipBtn {
    if (!_realDataTipBtn) {
        ...
        [_realDataTipBtn setTitleColor:[UIColor gc_colorWithHexString:@"#b64800"] forState:UIControlStateNormal];
        ...
        _realDataTipBtn.layer.borderColor = [UIColor gc_colorWithHexString:@"#b64800"].CGColor;

...
- (void)_setup {
    ...
    self.flashPointColor = [UIColor gc_colorWithHexString:@"#b64800"];
...
- (void)drawSetting {
    NSAttributedString *attString = [[NSAttributedString alloc] initWithString:[NSString stringWithFormat:@"%.2f", self.highItem.close.floatValue] attributes:@{NSFontAttributeName:self.yAxisTitleFont, NSForegroundColorAttributeName:self.yAxisTitleColor}];
